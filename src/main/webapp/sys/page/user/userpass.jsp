    ...
    <form class="layui-form" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="account" readonly lay-verify="required" placeholder="请输入账号" autocomplete="off"
                    class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
//     $("input[name='usercode']").prop("readonly","readonly");
    formSubmit('/userController/modifyPass.do', 'submit(pasUser)', 'text', function(data) {
