...
<div class="layui-collapse">
  <div class="layui-colla-item">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 0px; padding: 5px">
        <legend>商品信息-查询</legend>
        <form class="layui-form">
            <div class="layui-form-item">
                <label class="layui-form-label">编号</label>
                <div class="layui-input-inline">
                    <input type="text" name="procode" placeholder="编号" autocomplete="off" class="layui-input">
                </div>
                <label class="layui-form-label">名称</label>
                <div class="layui-input-inline">
                    <input type="text" name="proname" placeholder="名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
formSubmit('/productController/getList.do', 'submit(pro_search)', 'json', function(data) {
    ...
    $.each(data.list,function(i, dom) {
        ...
        html+="<tr><td>"+(i+1+(curr-1)*limit)+"</td><td>"+dom.procode+"</td><td>"+dom.proname+"</td>"
        	+"<td>"+dom.price+"</td><td>"+dom.amount+"</td><td>"+dom.descr+"</td><td>"+dom.state+"</td><td>"+dom.proclassname+"</td>"
            ...
            +"<input type='button' class='layui-btn' onclick='imgPro(\""+id+"\")' value='图片管理' />&nbsp;"
            +"</td></tr>";
    });
...
function openAddProClass(){
	openLayer('/sys/page/prodinfo/proinfoadd.jsp',refresh)
}
function imgPro(id){
	openLayer('/sys/page/prodinfo/proimg.jsp?id='+id,refresh)
}
...
function delPro(id){
	...
	ajax('/productController/del.do', {id:id}, 'text', function(data){
